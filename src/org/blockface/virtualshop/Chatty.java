...
public class Chatty {
	...
	public static void SendGlobal(String message) {
		plugin.getServer().broadcastMessage(
				ChatColor.DARK_GREEN + prefix + message);
	}
	...
	public static String FormatPrice(double price) {
		return ChatColor.YELLOW + VirtualShop.economy.format(price)
				+ ChatColor.WHITE;
	}
	...
	public static String FormatOffer(Offer o) {
		return FormatSeller(o.seller) + ": "
				+ FormatAmount(Integer.valueOf(o.item.getAmount())) + " "
				+ FormatItem(ItemDb.reverseLookup(o.item)) + " for "
				+ FormatPrice(o.price) + " each.";
	}

	public static String FormatTransaction(Transaction t) {
		return FormatSeller(t.seller) + " --> " + FormatBuyer(t.buyer) + ": "
				+ FormatAmount(Integer.valueOf(t.item.getAmount())) + " "
				+ FormatItem(ItemDb.reverseLookup(t.item)) + " for "
				+ FormatPrice(t.cost);
	}
}